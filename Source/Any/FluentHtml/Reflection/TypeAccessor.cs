...
namespace FluentHtml.Reflection
{
    ...
    public class TypeAccessor
    {
        ...
        /// <returns>An <see cref="IMethodAccessor"/> instance for the method if found; otherwise <c>null</c>.</returns>  
        ...
        /// <summary>  
        /// Searches for a method with the specified name and parameter types.  
        /// </summary>  
        /// <param name="name">The name of the method to find.</param>  
        /// <param name="parameterTypes">An array of <see cref="Type"/> objects representing the number, order, and type of the parameters for the method to find.</param>  
        /// <returns>An <see cref="IMethodAccessor"/> instance for the method if found; otherwise <c>null</c>.</returns>  
        ...
        /// <summary>  
        /// Searches for a method with the specified name, parameter types, and binding flags.  
        /// </summary>  
        /// <param name="name">The name of the method to find.</param>  
        /// <param name="parameterTypes">An array of <see cref="Type"/> objects representing the number, order, and type of the parameters for the method to find.</param>  
        ...
        private IMethodAccessor? CreateMethodAccessor(string name, Type[] parameters, BindingFlags flags)
        {
            ...
            return info is null ? null : CreateAccessor(info);
        }
...
#if NETCOREAPP
        [return: NotNullIfNotNull(nameof(methodInfo))]
#endif
        private static IMethodAccessor? CreateAccessor(MethodInfo methodInfo)
        {
            return methodInfo is null ? null : new MethodAccessor(methodInfo);
        }        
        ...
        private IMemberAccessor? CreateAccessor(string name, BindingFlags flags)
        {
            ...
            return field is null ? null : CreateAccessor(field);
        }
        #endregion
        ...
        private IMemberAccessor? CreateColumnAccessor(string name, BindingFlags flags)
        {
            ...
            foreach (var p in Type.GetProperties(flags))
            {
                ...
                if (columnAttribute is not null && name.Equals(columnAttribute.Name, StringComparison.OrdinalIgnoreCase))
                    return CreateAccessor(p);
        ...
        public IMemberAccessor? FindProperty<T>(Expression<Func<T>> propertyExpression)
        {
            ...
            return FindProperty(memberExpression);
        }
