...
{
    /// <summary>
    /// Define la interfaz para el acceso y la invocación de métodos reflejados en tiempo de ejecución.
    /// Permite obtener información del método y ejecutarlo dinámicamente sobre una instancia.
    /// </summary>
