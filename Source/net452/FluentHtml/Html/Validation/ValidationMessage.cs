...
namespace FluentHtml.Html.Validation
{
    public class ValidationMessage : ViewComponentBase
    {
        public ValidationMessage(HtmlHelper htmlHelper)
            : base(htmlHelper)
        {
            this.ValidationInputValidCssClassName = HtmlHelper.ValidationInputValidCssClassName;
            this.ValidationErrorCssClassName = HtmlHelper.ValidationMessageCssClassName;
            this.ValidationValidCssClassName = HtmlHelper.ValidationMessageValidCssClassName;            
        }
        ...
        public override string ToHtmlString()
        {
            ...
            else
            {
                ...
                if (this.HtmlAttributes.ContainsKey("id"))
                    id = this.HtmlAttributes["id"].ToString();
